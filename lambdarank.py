...
class RankerNN(object):
    ...
    def __init__(self, input_size, hidden_layer_sizes=(100,), activation=('relu',), solver='adam'):
        ...
        self.model.compile(optimizer=solver, loss='binary_crossentropy', metrics=['accuracy'])
    ...
    def fit(self, X, y, qid, batch_size=None, epochs=1, verbose=1, validation_split=0.0):
        ...
        self.model.fit([X1_trans, X2_trans], y_trans, sample_weight=weight, batch_size=batch_size, epochs=epochs, verbose=verbose, validation_split=validation_split)
...
class RankNetNN(RankerNN):
    ...
    def _transform_pairwise(self, X, y, qid):
        ...
        X2_trans : array, shape (k, n_feaures)
            Features of pair 2
        weight: array, shape (k, n_features)
